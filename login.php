    ...
    <div class="formulario">
      ...
      <form method="POST" name="form1" id="form1" action="controller/inicio.php" autocomplete="off">
        ...
        <div class="password-container">
          ...
          <input type="password" name="password" id="password" pattern="[A-Za-z0-9]{8}" placeholder="Ingrese la contraseña" title="La contraseña debe tener números y letras (8 caracteres)">
          </div>
        </div>
        <br><br>
