...
if (isset($_GET['id']) && !empty($_GET['id'])) {
    ...
    try {
        ...
        if ($resultados_vehiculo) {
            ...
            $sql_vehiculos_anuales = "SELECT va.vehiculo_id, va.anio, va.fecha_registro, i.valor, i.valor_imp, i.porcentaje, va.valor_total
                                    ...
                                    WHERE va.estado = 1 AND va.vehiculo_id = :id";
            ...
            if ($stmt_anual->rowCount() > 0) {
                ...
                echo "<p>No se encontraron pagos anuales asociados.</p>";
            }
        } else {
